var aa_inputList = {};
var aa_submitButtonDependency = {};
var showAlertOnIncorrectParamIfErrorContainerNotFound = false;

function aa_createInput(inpId, inpType, defValue, submitButtonId, errorMsgContainerId, isManadatory, style, className, otherOptions) {
...
function aa_verifyInputValue(inpID) {
...
function aa_selectOption(inpID, options, selected){
